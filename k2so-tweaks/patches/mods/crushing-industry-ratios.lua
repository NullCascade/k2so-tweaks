...
function patch.on_data()
	...
	util.graphics.set_standardized_dual_icon("recipe", "kr-enriched-crushed-iron", "item", "kr-enriched-iron", "item", "crushed-iron-ore")
	...
	util.graphics.set_standardized_dual_icon("recipe", "kr-enriched-crushed-copper", "item", "kr-enriched-copper", "item", "crushed-copper-ore")
