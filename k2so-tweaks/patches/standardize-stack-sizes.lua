...
function patch.on_data_final_fixes()
	...
	set_stack_size("item", "aluminum-crushed", default_stack_size)
	...
	set_stack_size("item", "muluna-diffused-plastic", default_stack_size)
	set_stack_size("item", "muluna-lunar-regolith", default_stack_size)
	set_stack_size("item", "muluna-microcellular-plastic", default_stack_size)
