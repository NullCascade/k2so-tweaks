...
While mods update, it seems that K2 migration files have broken a lot of mods that use their own basic resources (e.g. nitric acid). Additionally, Spaced Out introduced a lot of bugs in K2SO v2.0 that the author does not intend on fixing in favor of focusing on Factorio 2.1 development. These versions are stable and what I am using until other mods can update:
